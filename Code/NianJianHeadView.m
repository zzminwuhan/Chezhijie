...
@implementation NianJianHeadView
...
//    [self addSubview:line];
    ...
    self.frame = CGRectMake(0, 0, SCREEM_WIDTH, _carView.bottom + 20);
...
- (void)creatLabel {
    ...
    _label6 = [[UILabel alloc]initWithFrame:CGRectMake(15, y+44*2, SCREEM_WIDTH - 30, 44)];
    _label6.textColor = RGB(50, 50, 50);
    _label6.font = FONT14;
    [self addSubview:_label6];
    
    UILabel *line6 = [[UILabel alloc]initWithFrame:CGRectMake(0, _label6.bottom, SCREEM_WIDTH, 0.5)];
    line6.backgroundColor = RGB(200, 200, 200);
    ...
    _carView = [[NJCarView alloc]initWithFrame:CGRectMake(SCREEM_WIDTH - w - 15, _label4.bottom + 8, w, h)];
...
- (void)dataWithModel:(OrderModel*)model {
    ...
    _label6.text = [NSString stringWithFormat:@"类型：%@",model.njtype];
    
    
    [_carView dataWithModel:model.car];
