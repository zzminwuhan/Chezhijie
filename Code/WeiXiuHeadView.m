...
- (void)creatView {
    ...
    self.frame = CGRectMake(0, 0, SCREEM_WIDTH, _label3.bottom + 30);
...
- (void)creatLabel {
    ...
    _label3 = [[UILabel alloc]initWithFrame:CGRectMake(15, y+44*2, SCREEM_WIDTH - 30, 44)];
...
//    _label4 = [[UILabel alloc]initWithFrame:CGRectMake(15, y+44*3, SCREEM_WIDTH - 30, 44)];
...
//    
//    _label5 = [[UILabel alloc]initWithFrame:CGRectMake(15, y+44*4, SCREEM_WIDTH - 30, 44)];
...
- (void)dataWithModel:(OrderModel*)model {
    ...
    _discount.text = [NSString stringWithFormat:@"%@",model.discount];
