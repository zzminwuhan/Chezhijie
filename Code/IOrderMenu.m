...
- (void)creatView {
    ...
    _line = [[UILabel alloc]initWithFrame:CGRectMake(btn.left + btn.width/2 - 20, self.height - 2, 40, 2)];
...
- (void)btnAction:(UIButton*)btn {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        _line.frame = CGRectMake(btn.left + btn.width/2 - 20, self.height - 2, 40, 2);
    }];
